...
def notes_menu(notes_book_manager, user_interface, manage_notes_abc, sort_choice_abc, choose_note_abc,
    ...
    while True:
        ...
        match notes_choice:
            case '1':
                display_note(notes_book_manager, user_interface)
            case '2':
            ...
            case '4':
                sort_note(sort_choice_abc, user_interface, notes_book_manager)
            case '5':
...
def display_note(notes_book_manager, user_interface):
...
def sort_note(sort_choice_abc, user_interface, notes_book_manager):
